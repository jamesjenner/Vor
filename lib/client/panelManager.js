...
//  }
  ...
  // TODO: not sure we need to persist data attributes, trust the server to hold these?
...
function addPanelToDom(panel, buttonsVisible) {
  ...
  $("#columnContainer" + panel.column).append(
    ...
    '        </button>' +
    '        <button id="panelBtnModify' + panel.id + '" type="button" class="configButtons btn btn-default btn-sml ' + displayButtonClass + '" style="display: ' + displayStyle + ';">' +
