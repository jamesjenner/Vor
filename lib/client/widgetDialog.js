...
function viewWidgetWizard(mode, widget, panelId) {
  ...
  setWidgetDialogWidgetTypeValues(addWidgetWizardDialog.getSerializedForm(), widget.type);
  if(mode === 'modify') {
  ...
  $("#widgetDataSourcePicker").on('change', function() {
    setWidgetDialogWidgetTypeValues(addWidgetWizardDialog.getSerializedForm(), $('#widgetTypePicker').val());
  });
  ...
  $("#widgetTypePicker").on('change', function() {
    ...
    setWidgetDialogWidgetStyleValues(addWidgetWizardDialog.getSerializedForm(), $('#widgetTypePicker').val());
  });
}
...
function setWidgetDialogWidgetTypeValues(fields, value) {
  var i;
  var add = false;
  var dataSource = null;
  ...
  dataSource = dataSourceManager.getDataSourceByName(fields.widgetDataSourceName);
  ...
  setWidgetDialogWidgetStyleValues(fields, value);
}

function setWidgetDialogWidgetStyleValues(fields, selectedValue) {
  var dataSource = null;
  ...
  if(dataSource !== null) {
    for(var type in DataSource.DISPLAY_OPTIONS[dataSource.type]) {
      if(DataSource.DISPLAY_OPTIONS[dataSource.type][type].display !== undefined && DataSource.DISPLAY_OPTIONS[dataSource.type][type].display !== null) {
        if(DataSource.DISPLAY_OPTIONS[dataSource.type][type].name === selectedValue) {
...
function processWidgetDialog(mode, widget) {
  ...
  dataSource = dataSourceManager.getDataSourceByName(dialogData.widgetDataSourceName);
