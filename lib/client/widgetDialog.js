  ...
  var addWidgetWizardDialog = new BootBoxWiz({
    ...
    },                  
    {
      ...
      content: [
        ,
        '<div class="form-group">' +
        '  <label class="col-md-4 control-label" for="widgetVersionOneDataValueType">Value Type</label> ' +
        '  <div class="col-md-6">' + 
        '    <select id="widgetVersionOneDataValueTypePicker" name="widgetVersionOneDataValueType" class="widgetselectpicker">' +     
