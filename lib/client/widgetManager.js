...
WidgetManager.prototype.__updateJenkinsWidget = function(widget, data) {
  ...
  switch(widget.style) {
    ...
    case Widget.DISPLAY_TYPE_PROGRESS:
      console.log("update jenkins widget progress");
    ...
    case Widget.DISPLAY_TYPE_HISTORY:
      ...
      this.__updateWidgetHistory(widget, value1, color);
      break;
  }
};
...
WidgetManager.prototype.__updateWidgetHistory = function(widget, value, color) {
  this.widgetControls[widget.id].pushValue(value, color);
};
