...
WidgetManager.prototype._getWidgetControls = function(widget) {
  ...
  return (
    ...
    '      <button id="widgetBtnLeft' + widget.id + '" type="button" class="btn btn-default btn-sml btn-left config-buttons ' + displayButtonClass + '" style="display: ' + displayStyle + ';">' +
    '        <i class="fa fa-chevron-left"></i>' +
    '      </button>' +
    '      <button id="widgetBtnRight' + widget.id + '" type="button" class="btn btn-default btn-sml btn-right config-buttons ' + displayButtonClass + '" style="display: ' + displayStyle + ';">' +
