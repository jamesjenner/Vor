...
WidgetManager.prototype.receivedData = function(data) {
  ...
  for(var i = 0; i < this.widgets.length; i++) {
    if(this.widgets[i].keyDataElement === data.keyDataElement) {
      console.log("updating widget: " + this.widgets[i].title + " for data source id: " + this.widgets[i].dataSourceId);
/*
 * data source example
 * 
		"id": "caee0478-4ced-4227-9f72-fd59e0ab889d",
		"type": "Version One",
		"name": "Version One Test #1",
		"protocol": "https",
		"hostname": "www11.v1host.com",
		"port": "443",
		"instance": "/VentyxProd/",
		"username": "james.jenner",
		"password": "Lazy Idiots Security Risk Does Create",
		"pollFrequencyMinutes": "5",
 ...
 * widget example
 *      
		"id": "df111903-17af-4832-93dc-93cba076be6c",
		"title": "Progress X",
		"type": "Progress by State",
		"style": "Donut Chart",
		"dataSourceId": "Version One Test #1",
		"panelId": "cfbdfb79-5e79-4eeb-8060-30647fbdb305",
		"keyDataElement": "Ellipse - Materials 1",
		"thresholdMode": "Numeric Range",
		"marginSafe": 0,
		"marginDanger": 0,
		"targetDataElement": "",
		"displayLabels": false,
