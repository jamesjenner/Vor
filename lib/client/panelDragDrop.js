...
var PanelDragAndDrop = function(options) {
  ...
  this.columnSelector = (options.columnSelector !== null && options.columnSelector !== undefined) ? options.columnSelector : ".column";
...
PanelDragAndDrop.prototype._dragOccured = function() {
  ...
  sendMovePanel($(this.dragPanel).data("id"), fromPanel, toPanel, this.newIndex);
};
