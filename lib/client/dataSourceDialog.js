...
function viewDataSourceWizard(mode, dataSource) {
  ...
  var addWidgetWizardDialog = new BootBoxWiz({
    ...
    stepContent: [ {
      ...
      '  <div class="col-md-3"> ' +
      '    <input id="dataSourceFrequency" name="dataSourceFrequency" type="number" placeholder="Enter the frequency that data is retreived, in minutes" class="form-control input-md"> ' +
      '  </div> ' +
      '</div> ',
    },
    {
      ...
      '<div class="form-group">' +
      '  <label class="col-md-4 control-label" for="v1Protocol">Protocol</label>' +
      '  <div class="col-md-3"> ' +
      '    <input name="v1Protocol" maxlength="200" type="text" required="required" class="form-control input-md" placeholder="Enter the protocol (http|https)" />' +
      '  </div>' +
      '</div>' +
      '<div class="form-group">' +
      '  <label class="col-md-4 control-label" for="v1HostName">Hostname</label>' +
      '  <div class="col-md-6"> ' +
      '    <input name="v1HostName" maxlength="200" type="text" required="required" class="form-control" placeholder="Enter the hostname" />' +
      '  </div>' +
      '</div>' +
      '<div class="form-group">' +
      '  <label class="col-md-4 control-label" for="v1Port">Port</label>' +
      '  <div class="col-md-3"> ' +
      '    <input name="v1Port" maxlength="200" type="number" required="required" class="form-control" placeholder="Enter the port" />' +
      '  </div>' +
      '</div>' +
      '<div class="form-group">' +
      '  <label class="col-md-4 control-label" for="v1Instance">Instance</label>' +
      '  <div class="col-md-6"> ' +
      ...
      '</div>' +
      '<div class="form-group">' +
      '  <label class="col-md-4 control-label" for="v1UserName">Username</label>' +
      '  <div class="col-md-6"> ' +
      '    <input name="v1UserName" maxlength="200" type="text" required="required" class="form-control" placeholder="Enter username" />' +
      '  </div>' +
      '</div>' +
      '<div class="form-group">' +
      '  <label class="col-md-4 control-label" for="v1Password">Password</label>' +
      '  <div class="col-md-6"> ' +
      '    <input name="v1Password" maxlength="200" type="password" required="required" class="form-control" placeholder="Enter the password" />' +
      '  </div>' +
      '</div>',

      '<div class="form-group">' +
      '  <label class="col-md-4 control-label" for="jenkinsProtocol">Protocol</label>' +
      '  <div class="col-md-3"> ' +
      ...
      '</div>' +
      '<div class="form-group">' +
      '  <label class="col-md-4 control-label" for="jenkinsHostName">Hostname</label>' +
      '  <div class="col-md-6"> ' +
      '    <input name="jenkinsHostName" maxlength="200" type="text" required="required" class="form-control" placeholder="Enter the hostname" />' +
      '  </div>' +
      '</div>' +
      '<div class="form-group">' +
      '  <label class="col-md-4 control-label" for="jenkinsPort">Port</label>' +
      '  <div class="col-md-3"> ' +
      '    <input name="jenkinsPort" maxlength="200" type="number" required="required" class="form-control" placeholder="Enter the port" />' +
      '  </div>' +
      '</div>',

      '<div class="form-group">' +
      '  <label class="col-md-4 control-label" for="sfdcProtocol">Protocol</label>' +
      '  <div class="col-md-3"> ' +
      ...
      '</div>' +
      '<div class="form-group">' +
      '  <label class="col-md-4 control-label" for="sfdcHostName">Hostname</label>' +
      '  <div class="col-md-6"> ' +
      '    <input name="sfdcHostName" maxlength="200" type="text" required="required" class="form-control" placeholder="Enter the hostname" />' +
      '  </div>' +
      '</div>' +
      '<div class="form-group">' +
      '  <label class="col-md-4 control-label" for="sfdcUserName">Username</label>' +
      '  <div class="col-md-6"> ' +
      '    <input name="sfdcUserName" maxlength="200" type="text" required="required" class="form-control" placeholder="Enter username" />' +
      '  </div>' +
      '</div>' +
      '<div class="form-group">' +
      '  <label class="col-md-4 control-label" for="sfdcPassword">Password</label>' +
      '  <div class="col-md-6"> ' +
      '    <input name="sfdcPassword" maxlength="200" type="password" required="required" class="form-control" placeholder="Enter the password" />' +
      '  </div>' +
      '</div>' +
      '<div class="form-group">' +
      '  <label class="col-md-4 control-label" for="sfdcPort">Port</label>' +
      '  <div class="col-md-3"> ' +
      '    <input name="sfdcPort" maxlength="200" type="number" required="required" class="form-control" placeholder="Enter the port" />' +
      '  </div>' +
      '</div>',

      '<div class="form-group">' +
      '  <label class="col-md-4 control-label" for="internalProtocol">Protocol</label>' +
      '  <div class="col-md-3"> ' +
      ...
      '</div>' +
      '<div class="form-group">' +
      '  <label class="col-md-4 control-label" for="internalHostName">Hostname</label>' +
      '  <div class="col-md-6"> ' +
      '    <input name="internalHostName" maxlength="200" type="text" required="required" class="form-control" placeholder="Enter the hostname" />' +
      '  </div>' +
      '</div>' +
      '<div class="form-group">' +
      '  <label class="col-md-4 control-label" for="internalPort">Port</label>' +
      '  <div class="col-md-3"> ' +
      '    <input name="internalPort" maxlength="200" type="number" required="required" class="form-control" placeholder="Enter the port" />' +
      '  </div>' +
      '</div>' +
      '<div class="form-group">' +
      '  <label class="col-md-4 control-label" for="internalUserName">Username</label>' +
      '  <div class="col-md-6"> ' +
      '    <input name="internalUserName" maxlength="200" type="text" required="required" class="form-control" placeholder="Enter username" />' +
      '  </div>' +
      '</div>' +
      '<div class="form-group">' +
      '  <label class="col-md-4 control-label" for="internalPassword">Password</label>' +
      '  <div class="col-md-6"> ' +
      '    <input name="internalPassword" maxlength="200" type="password" required="required" class="form-control" placeholder="Enter the password" />' +
      '  </div>' +
      '</div>',
      ],
    }
