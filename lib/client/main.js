...
//  $(".config-buttons").fadeIn("slow", function() {}).addClass('displayButton').css('display', '');
  ...
  $("#column" + nextPosition.col).append(
    ...
    '    <svg xmlns="http://www.w3.org/2000/svg" class="plus-icon" viewBox="0 0 100 100">' +
    '      <use xlink:href="./images/add_circle_plain.svg#layer1"></use>' +
    '    </svg>' +
    '  </div>' +
    '</div>'
...
//  $('#panelAddButton').on('click', function() {
