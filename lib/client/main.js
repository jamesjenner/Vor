...
function configureApplication() {
  ...
  server = new Server({
    messageHandlers: [
      ...
      preferencesManager.processMessages.bind(preferencesManager),
  ...
  preferencesManager.server = server;
  server.connect();
...
function addApplicationButtonListeners() {
  ...
  preferencesManager.setupPreferencesPane();
}
