...
//          result["_v1_current_data"]["IsInactive"] + "\t" +
          ...
          result["_v1_current_data"]["Source.Name"] + "\t" +
...
function _getStoriesforProjectProgram(options) {
  options = options !== undefined ? options : {};
...
//      'Custom_EPEstDate',
      ...
      'Custom_ScreenID',
      'Custom_SFDCAccount5',
      'Custom_SFDCCaseNumber4',
      'Custom_SFDCChangeReqID3',
      'Custom_SFDCRequestByDate4',
      'Custom_SubComponent6',
//      'Custom_VersionAffected4',
      'Custom_VersionAffected4.Name',
      'Scope.Name',
    ],
    where: whereStatement,
    success: function(result) {
      var accountName = _getAccountName(result['_v1_current_data']['Custom_SFDCAccount5']);
//      if(result["_v1_current_data"]["ID.Number"] === undefined) {
//        console.log(JSON.stringify(result, null, ' '));
//      }
      if(result["_v1_current_data"]["ID.Number"] !== undefined && 
         result['_v1_current_data']['Custom_SubComponent6'].toUpperCase() !== "DATAFIX" && 
        result['_v1_current_data']['Custom_SubComponent6'].toUpperCase() !== "DATA FIX" &&
        result['_v1_current_data']['Custom_SubComponent6'].toUpperCase() !== "SQL DATAFIX" &&
         (accountName !== 'Commonwealth of Australia Department of Defence' || 
          (accountName !== 'Commonwealth of Australia Department of Defence' && 
           result['_v1_current_data']['Custom_SubComponent4'].substr(0, 2).toUpperCase() !== 'DD'
          )
...
//          result["_v1_current_data"]["CreateDateUTC"] + "\t" +
          ...
          accountName + "\t" +
          "\t" +
          result['_v1_current_data']['Custom_SFDCCaseNumber4'] + "\t" +
          result['_v1_current_data']['Custom_SFDCChangeReqID3'] + "\t" +
          result['_v1_current_data']['Custom_SFDCRequestByDate4'] + "\t" +
  //        result['_v1_current_data']['Custom_VersionAffected4'] + "\t" +
          ''
        );
      }
    },
