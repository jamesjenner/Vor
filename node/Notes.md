...
Of those investigated, moment.js appears to be the most appropriate.

###Performance
Performance of various time libs is available at http://jsperf.com/date-formatting/8

###Recognised timezones
All libraries investigated use the same source for timezones, an international non-profit
organisation that tracks timezone information. The following is a list of the available
timezones (as of 30 Aug, 2014).
...
###Locales
The following is a list of availbale locales from within Java. This appears to be suitable for moment.js.
